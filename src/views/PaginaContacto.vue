              ...
              <v-row>
                ...
                <div class="d-flex flex-column">
                  <v-checkbox
                    v-model="ex4"
                    color="success"
                    label="Acepto las Politicas de privacidad del sitio Web"
                    value=""
                    hide-details
                  ></v-checkbox>
                  <v-btn block="" color="success" class="mt-4"> Enviar </v-btn>
                </div>
              </v-row>
            </v-container>
          </v-form>
        ...
        <v-col cols="12" sm="6" class="vision" style="padding-right: 20%">
          ...
          <v-card elevation="0" color="transparent" class="pl-10">
            <v-card-text
              ...
              >Av. La Paz No. 2453 , Colonia Arcos Sur CP 44100 Guadalajara, Jalisco Mexico
            </v-card-text>
            <v-card-text
              class="px-0 pb-1 d-flex justify-right"
              style="color: rgb(71, 71, 71); gap: 10px; font-size: 20px"
              ...
              >Calle Mezquitán No. 302, Col. Centro Barranquitas, C.P. 44100 Guadalajara, Jalisco
              Mexico
            </v-card-text>

            <v-card-text
              class="pt-2 pb-2 px-0 d-flex justify-right"
              style="color: rgb(71, 71, 71); gap: 10px; font-size: 20px"
              ><span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              ><span>333268888 ext. 18801, 3332688888 ext. 18804</span>
            </v-card-text>
            <v-card-text
              class="pt-0 pb-4 px-0 d-flex justify-right"
              style="color: rgb(71, 71, 71); gap: 10px; font-size: 20px"
              ><span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              ><span>Email: <a href="#">contacto@udg.mx</a></span></v-card-text
            >
            <div class="social d-flex justify-center justify-items-center" style="gap: 25px">
              <span class="facebook">
