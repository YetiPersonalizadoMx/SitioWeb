<template>
  <div class="checkout">
    <v-container fluid class="ma-0 pa-0">
      <v-row>
        <v-col cols="12" lg="7" md="6" class="order-1 order-lg-0">
          <v-card
          ...
          >
            ...
            <v-card-actions class="justify-space-between align-center my-7">
              <v-btn color="#6039F4" variant="elevated" class="flex-grow-1" height="45"
                ><svg
              ...
              <v-btn color="black" variant="elevated" class="flex-grow-1" height="45">
            ...
            <v-card-title
              style="
                ...
                line-height: 1.2;
              "
              >Información de Envío</v-card-title
            >
            <select
              name=""
              id=""
            ...
            <div class="user-name d-flex align-center justify-center" style="gap: 10px">
              <input
                type="text"
                class="pa-3 mt-4"
                placeholder="Nombre"
            ...
            <div class="city-parent d-flex align-center justify-center" style="gap: 10px">
              <input
                type="text"
                class="pa-3 mt-4"
                placeholder="Ciudad"
            ...
            <v-card-actions class="justify-end mt-7">
              <v-btn variant="elevated" color="blue" height="45" width="200" @click="dialog = true"
                >Realizar Pedido</v-btn
              >
            </v-card-actions>
            <v-divider length="100%" color="black"></v-divider>
            <v-card-text style="font-size: 10px; color: #777"
              >Todos los derechos reservados.</v-card-text
            >
          </v-card>
        </v-col>
        <v-col cols="12" lg="5" md="6" class="">
          <v-card
          ...
          >
            ...
            >
              <v-badge :content="item.quantity" color="grey-darken-1" style="margin-top: 8px">
                <img
                  :src="item.thumbnail"
                  alt=""
                  width="60"
                  style="border-radius: 7px; border: 1px solid rgb(186, 186, 186)"
                />
              </v-badge>
              ...
              <div class="title-parent flex-grow-1">
                ...
                >
                <v-card-text style="font-size: 12px; color: #777; white-space: pre-wrap">{{
                  item.category
                }}</v-card-text>
              </div>
              <v-card-text class="flex-grow-0" style="font-size: 12px"
                >${{
    ...
    <PedidosRealizados :popup="dialog" v-if="dialog" @close_popup="dialog = false" />
  </div>
</template>
<script>
import { cartStore } from '@/components/stores/cart'
import { mapState } from 'pinia'
import PedidosRealizados from '@/components/pedidos/PedidosRealizados.vue'
export default {
  data: () => ({
    paises: ['México', 'USA'],
    dialog: false,
