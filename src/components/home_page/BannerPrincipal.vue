    ...
    <div class="content">
      <v-carousel height="200" :show-arrows="false" cycle hide-delimiter-background hide-delimiters>
        ...
        <v-carousel-item>
          ...
          <h1 style="margin-top: 10px">Temporada Verano</h1>
          <v-btn
            density="default"
        ...
        <v-carousel-item>
          <h2>Siguenos en nuestras</h2>
          <h1 style="margin-top: 10px">Redes Sociales</h1>

          <div
            class="social d-flex align-center justify-content-center"
            style="gap: 20px; margin-top: 20px"
          >
            <span class="facebook">
              <a href="#">
                <svg
