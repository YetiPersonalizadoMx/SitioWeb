<template>
  <div class="app-footer">
    <v-footer :app="true" color="grey-lighten-4" absolute class="pt-15">
      <v-container fluid>
        <v-row>
          ...
          <v-col cols="12" sm="6" md="4" lg="3">
            <v-card elevation="0" color="transparent">
              ...
              <v-card-text
                class="px-0 pb-1 d-flex justify-center"
                style="color: rgb(71, 71, 71); gap: 10px"
                ><span class="pt-0">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    style="width: 20px; fill: #686868"
                  >
                ...
                ><span
                  >Av. La Paz No. 2453 , Colonia Arcos Sur CP 44100 Guadalajara, Jalisco
                  Mexico</span
                ></v-card-text
              >

              <v-card-text
                class="pt-0 pb-1 px-0 d-flex justify-right"
                style="color: rgb(71, 71, 71); gap: 10px"
                ><span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                ><span>333268888 ext. 18801</span></v-card-text
              >
              <v-card-text
                class="pt-0 pb-2 px-0 d-flex justify-right"
                style="color: rgb(71, 71, 71); gap: 10px"
                ><span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
