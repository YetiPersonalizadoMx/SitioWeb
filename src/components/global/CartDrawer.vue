<template>
  <div class="drawer">
    ...
    >
      ...
      <v-card
        class="pa-0 mt-0 items-card"
        elevation="0"
        v-if="cartItems.length"
        max-height="270"
        style="overflow-y: auto"
      >
        <div class="bar-parent mt-4 pr-5 position-relative">
          <svg
        ...
        <v-card-text
          ...
          >Solo faltan ${{ 500 - calcTotalPrice }} para obtener envío gratis.</v-card-text
        >
        <v-card-text
          class="px-0 pt-2"
          style="color: #6f6f6f"
